  ...
  return (
    <div className="i">
      <div className="i-left">
        <p className="i-greeting">Hi There</p>
        <h1 className="i-name">Rohit Kumar</h1>
        <h3 className="i-role">Full Stack web developer</h3>
        <p className="i-desc">I’m a MERN stack developer
        <br />
         with the development skills based in Mumbai.</p>
        <div className="btn-box">
        <a href="#"><button className="i-btn">Contact me</button></a>
        </div>
